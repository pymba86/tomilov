  ...
  <div :class="$style.container">
    ...
    <section :class="$style.heroSection">
      ...
      <div :class="$style.heroContent">
        ...
        <p :class="$style.heroSubtitle">
          Создаю яркие и запоминающиеся танцевальные номера для свадебного торжества. Более 5 лет опыта работы на
          различных мероприятиях Челябинска и области.
        </p>
        ...
        <div :class="$style.aboutGrid">
          <div :class="$style.aboutText">
            ...
            <p :class="$style.aboutParagraph">
              Являюсь действующим спортсменом и тренером по спортивным бальным танцам. Неоднократный призёр
              Всероссийских и Международных соревнований.
            </p>
            <p :class="$style.aboutParagraph">
              Каждый номер создается индивидуально под вашу пару и особенности торжества, чтобы сделать ваш день
              незабываемым.
            </p>
          </div>
    ...
    <section :class="$style.servicesSection">
      <div :class="$style.servicesContainer">
        <h2 :class="[$style.sectionTitle, $style.centerTitle]">Что я предлагаю</h2>
        <div :class="$style.servicesGrid">
          ...
          >
            <div :class="[$style.serviceIcon, service.iconClass]">
              <component :is="service.icon" :class="$style.serviceIconSvg" />
            </div>
    ...
    <section :class="$style.gallerySection">
      <div :class="$style.galleryContainer">
        <h2 :class="[$style.sectionTitle, $style.centerTitle]">Галерея работ</h2>
    ...
    <section :class="$style.contactSection">
      <div :class="$style.contactContainer">
        <h2 :class="[$style.sectionTitle, $style.contactTitle]">Свяжитесь со мной</h2>
        <p :class="$style.contactSubtitle">
          Готов обсудить ваш танцевальный номер и воплотить мечты в реальность
        </p>
        ...
        <div :class="$style.contactGrid">
          ...
          >
            ...
            <h3 :class="$style.contactCardTitle">{{ contact.title }}</h3>
            <a 
              :href="contact.href" 
    ...
    <footer :class="$style.footer">
      <div :class="$style.footerContainer">
        <p :class="$style.footerText">
          © {{ currentYear }} Профессиональные танцевальные номера. Челябинск и область.
        </p>
      </div>
    </footer>
  </div>
...
const galleryImages = ref([
  { src: '/placeholder.svg?height=400&width=300', alt: 'Танцевальный номер 1' },
  { src: '/placeholder.svg?height=400&width=300', alt: 'Танцевальный номер 2' },
  { src: '/placeholder.svg?height=400&width=300', alt: 'Танцевальный номер 3' },
  { src: '/placeholder.svg?height=400&width=300', alt: 'Танцевальный номер 4' },
  { src: '/placeholder.svg?height=400&width=300', alt: 'Танцевальный номер 5' },
  { src: '/placeholder.svg?height=400&width=300', alt: 'Танцевальный номер 6' }
])
